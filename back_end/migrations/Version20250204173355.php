 ...
 */
final class Version20250204173355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, ticket_id INT NOT NULL, technician_id INT NOT NULL, details LONGTEXT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_D11814AB700047D2 (ticket_id), INDEX IDX_D11814ABE6C5D496 (technician_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
